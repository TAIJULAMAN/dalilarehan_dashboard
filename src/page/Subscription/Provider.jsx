...
import { useGetProvidersPagedQuery } from "../../redux/Api/userApi";

export default function Provider({ searchTerm = "" }) {
  ...
  const { data, isLoading } = useGetProvidersPagedQuery({
    ...
    // this page should only show premium providers
  ...
  const total = data?.pagination?.totalProviders ?? rows.length;
